...
*/
class mostrar_consolidado_resultado
{
	
function mostrar_consolidado_resultado()
{
	$this->tabla_resultado="";
}
...
function seleccion_unica($codigo_pregunta,$configuracion)
{
		...
		if($this->conteo_multiple>0)
		{
			...
			for($this->contador_m=0;$this->contador_m<$this->conteo_multiple;$this->contador_m++)
			{
				...
				$this->tabla_resultado.="<tr class='bloquecentralcuerpo'>\n";
				$this->tabla_resultado.="<td class='celdapresentacion'>\n";
				$this->tabla_resultado.=$this->encuestado."\n";
				$this->tabla_resultado.="</td>\n";
				$this->tabla_resultado.="<td class='celdapresentacion'>\n";
				$this->tabla_resultado.=($this->id_proceso/1)."\n";
				$this->tabla_resultado.="</td>\n";
				$this->tabla_resultado.="<td class='celdapresentacion'>\n";
				$this->tabla_resultado.=($this->artefacto/1)."\n";
				$this->tabla_resultado.="</td>\n";
				$this->tabla_resultado.="<td class='celdapresentacion'>\n";
				$this->tabla_resultado.=($this->pregunta/1)."\n";
				$this->tabla_resultado.="</td>\n";
				$this->tabla_resultado.="<td class='celdapresentacion'>\n";
				$this->tabla_resultado.=($this->valor/1)."\n";
				$this->tabla_resultado.="</td>\n";
				
				if($this->la_respuesta==FALSE)
				{
					//Para la tabal general de resultados
					$this->tabla_resultado.="<td class='celdapresentacion'>\n";
					$this->tabla_resultado.="0\n";
					$this->tabla_resultado.="</td>\n";
				...
				else
				{
					//Para la tabal general de resultados
					$this->tabla_resultado.="<td class='celdapresentacion'>\n";
					$this->tabla_resultado.="1\n";
					$this->tabla_resultado.="</td>\n";
		
				}
				
				$this->tabla_resultado.="</tr>\n";
...
function campos_multiples($codigo_pregunta,$configuracion)
{
		...
		if($this->conteo_multiple>0)
		{
			...
			for($this->contador_m=0;$this->contador_m<$this->conteo_multiple;$this->contador_m++)
			{
				...
				/*Determinar si existe una entrada en la base de datos*/
				/*Este tipo de métrica supone una sola respuesta por pregunta*/
				$this->la_respuesta=$this->buscar_respuesta_campos_multiples((($this->id_proceso)/1),(($this->instrumento)/1),(($this->pregunta)/1),(($this->instancia)/1),$this->contador_m,$this->encuestado,$configuracion,1,(($this->artefacto)/1));
				...
				$this->tabla_resultado.="</td>\n";
				$this->tabla_resultado.="<td class='celdapresentacion'>\n";
				$this->tabla_resultado.=($this->contador_m+1)."\n";
				$this->tabla_resultado.="</td>\n";
				
				if($this->la_respuesta==FALSE)
				{
					//Para la tabla general de resultados
					$this->tabla_resultado.="<td class='celdapresentacion'>\n";
					$this->tabla_resultado.="0\n";
					$this->tabla_resultado.="</td>\n";
				...
				else
				{
					//Para la tabla general de resultados
					$this->tabla_resultado.="<td class='celdapresentacion'>\n";
					$this->tabla_resultado.=$this->la_respuesta;
					$this->tabla_resultado.="</td>\n";
...
function buscar_respuesta_campos_multiples($proceso,$instrumento,$pregunta,$instancia,$opcion,$encuestado,$configuracion,$tipo,$artefacto)
{
