...
function verificar_numero(formulario,control)
{
  ...
  // En el caso de que no sea un número
    ...
    return true;
} // Fin de la funcion verificar_numero


function verificar_numero_lleno(formulario,control)
{
	var campo	= formulario.elements[control];
	var val		= parseInt(campo.value);
...
function verificar_rango(formulario,control, min, max)
{
    ...
    return true;
} // Fin de la funcion verificar_rango // Fin de la funcion verificar_rango
 ...
 * @return  boolean  TRUE si está diligenciado
 */
function seleccion_valida(formulario,control,etiqueta)
{
    var campo= formulario.elements[control];
    var valor= campo.value;
   if (valor==(-1)) 
    {
        alert1('Debe seleccionar una opción válida en el campo: \n'+etiqueta);
        campo.focus();
	return false;
     }
 ...
 * @return  boolean  TRUE si está diligenciado
 */
function validar_entero(formulario,control)
{
   	var campo= formulario.elements[control];
    	var entero= parseInt(campo.value);
    	var flotante= parseFloat(campo.value);
    	
	if (isNaN(entero)||isNaN(flotante)) 
	{
		campo.select();
		alert1('El valor introducido debe ser un número');
		campo.focus();
	...
	else
	{
		...
		{
			campo.select();
			alert1('El valor introducido debe ser un entero');
			campo.focus();
			return false;	
		}
...
function validar_entero_lleno(formulario,control)
{
   	var campo= formulario.elements[control];
    	var entero= parseInt(campo.value);
    	var flotante= parseFloat(campo.value);
