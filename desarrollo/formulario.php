	...
	if (is_resource($enlace))
	{
		...
		if($identificador!=-1)
		{
			...
			for($contador=0;$contador<$cantidad_campos;$contador++)
			{
				...
				$controles.="		<td bgcolor='<?php echo \$tema->celda ?>'>\n";
				...
				$tipo["control"]["valor"]="<?php echo \$registro[0][".$contador."] ?>";
				$controles_llenos.="	<tr class='bloquecentralcuerpo' onmouseover=\"setPointer(this, <?php echo \$contador ?>, 'over', '<?php echo \$tema->celda ?>', '<?php echo \$tema->apuntado ?>', '<?php echo \$tema->seleccionado ?>');\" onmouseout=\"setPointer(this, <?php echo \$contador ?>, 'out', '<?php echo \$tema->celda ?>', '<?php echo \$tema->apuntado ?>', '<?php echo \$tema->seleccionado ?>');\" onmousedown=\"setPointer(this, <?php echo \$contador++ ?>, 'click', '<?php echo \$tema->celda ?>', '<?php echo \$tema->apuntado ?>', '<?php echo \$tema->seleccionado ?>');\">\n";
				$controles_llenos.="		<td bgcolor='<?php echo \$tema->celda ?>'>\n";
				...
				$controles_mostrar.="		<td bgcolor='<?php echo \$tema->celda ?>'>\n";
				$controles_mostrar.="			".$tipo["control"]["nombre"].":\n";
				$controles_mostrar.="		</td>\n";
				$controles_mostrar.="		<td bgcolor='<?php echo \$tema->celda ?>'>\n";
				$controles_mostrar.="			<?php echo \$registro[0][".$contador."] ?>\n";
				$controles_mostrar.="		</td>\n";
			...
			$formulario_lleno.="	<tr align='center'>\n";
        		$formulario_lleno.="		<td colspan='2' rowspan='1'>\n";
