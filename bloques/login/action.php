...
function sesion_login($tipo,$configuracion,$registro,$acceso_db)
{
	...
	else 
	{
		if($tipo=="encuestado")
		{
			...
			$resultado = $nueva_sesion->guardar_valor_sesion($configuracion,"id_proceso",$registro[0][1],$esta_sesion);
			$resultado = $nueva_sesion->borrar_valor_sesion($configuracion,"id_artefacto",$esta_sesion);
			$resultado = $nueva_sesion->guardar_valor_sesion($configuracion,"id_artefacto",$registro[0][2],$esta_sesion);			
