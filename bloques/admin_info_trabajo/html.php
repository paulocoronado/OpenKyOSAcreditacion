...
<table style="text-align: left; width: 100%;" border="0"  cellpadding="5" cellspacing="0" class="bloquelateral">
  <tbody>
    <tr class="mensajealertaencabezado">
      <td >No hay informaci&oacute;n sobre trabajos realizados por estudiantes.</td>
    </tr>
    </tbody>
</table>
...
<tr class="mensajealertaencabezado">
<td colspan="4">Trabajos de los estudiantes:</td>
</tr>
...
<a href="<?php echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('registro_info_trabajo').'&id_trabajo='.$registro[$contador][0].'&usuario='.$_GET['usuario']; ?>">Editar</a>
</td>
<td align="center" class="celdatabla"><?php //TODO: Implementar la funcionalidad de Borrar?>
<a href="<?php echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('borrar_info_trabajo').'&opcion=info_trabajo&registro='.$registro[$contador][0].'&usuario='.$_GET['usuario'].'&nombre='.$registro[$contador][2].'&anno='.$registro[$contador][1]; ?>">Borrar</A>
</td>	
</tr><?php }?>
</table><br>
</form>
