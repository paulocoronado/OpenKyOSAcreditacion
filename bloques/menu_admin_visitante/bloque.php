...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral">
		...
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<BR><a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('registro_dir_visitante').'&usuario='.$_GET['usuario'].'&accion=1'; ?>">Agregar registro</A>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
		...
		<TD WIDTH=100% class="bloquelateralcuerpo">
				...
				<TR>
					<TD>
						Del a&ntilde;o:
						<input type="hidden" NAME="page" VALUE="<?php   echo enlace('admin_dir_visitante') ?>">
