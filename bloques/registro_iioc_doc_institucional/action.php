...
echo "<script>location.replace('".$configuracion["host"].$configuracion["site"]."/index.php?page=".enlace('admin_iioc_doc_institucional')."&accion=".$_POST['accion']."&error=".$error."')</script>";
