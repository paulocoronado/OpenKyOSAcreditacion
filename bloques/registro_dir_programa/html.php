...
if(isset($_GET['opcion']))
{
	...
	if($accion=="editar")
	{
		editar_registro($configuracion,$tema,$el_estilo,$id_programa);
	}
	else
	{
		...
		if($accion=="mostrar")
		{
			mostrar_registro($configuracion,$tema,$el_estilo,$id_programa);
...
function editar_registro($configuracion,$tema,$estilo,$id_programa)
{
	$tab=1;
	$contador=0;
		...
		<td>
			<table align='center' width='100%' cellpadding='7' cellspacing='1'>
				...
				<tr class='bloquecentralcuerpo'>
					...
					<td>
						<input type='text' name='fecha_registro' value='<?php echo $registro[0][12] ?>' size='30' maxlength='12' tabindex='<?php echo $tab++ ?>' >
					</td>
				</tr>	
				<tr class='bloquecentralcuerpo'>
				...
				<tr align='center'>
					<td colspan='2' rowspan='1'>
						...
						<input type='hidden' name='action' value='registro_dir_programa'>
...
function mostrar_registro($configuracion,$tema,$estilo,$id_programa)
{
	$tab=1;
	$contador=0;
	$acceso_db=new dbms($configuracion);
	...
	if (is_resource($enlace))
	{
		...
		if($campos>0)
		{
?><table class='bloquelateral' align='center' width='100%' cellpadding='7' cellspacing='0'>
	<tr>
		<td>
			<table align='center' width='100%' cellpadding='2' cellspacing='1' border="0">
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">
						<span class="encabezado_datos"><?php echo $registro[0][2] ?></span><br>
						<?php echo $registro[0][17] ?>						
					</td>
				</tr>
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">
						<?php echo $registro[0][3] ?><hr class="hr_division">
					</td>
				</tr>
				<tr class='bloquecentralcuerpo'>
					<td>
						<table>
							<tr class='bloquecentralcuerpo'>
								...
								<td>
									<?php echo $registro[0][18] ?>
								</td>
							</tr>
							<tr class='bloquecentralcuerpo'>
								<td>
									<span class="texto_negrita">Registro ICFES:</span>
								</td>
								<td>
				...
				?><tr class='bloquecentralcuerpo'>
					<td colspan="2" align="left">
						<span class="encabezado_normal">Visi&oacute;n</span><hr class="hr_division">
					</td>
				</tr>
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">						
				...
				?><tr class='bloquecentralcuerpo'>
					<td colspan="2" align="left">
						<span class="encabezado_normal">Misi&oacute;n</span><hr class="hr_division">
					</td>
				</tr>	
				<tr class='bloquecentralcuerpo'>		
					<td colspan="2">						
				...
				<tr class='bloquecentralcuerpo'>
					<td colspan="2">
						<span class="encabezado_normal">Datos Generales</span>		
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>
						<table>
							<tr class='bloquecentralcuerpo'>
								<td>
									<span>Norma de Creaci&oacute;n:</span>
								</td>
								<td>
							...
							<tr class='bloquecentralcuerpo'>
								<td>
									<span>Semanas por periodo:</span>
								</td>
								<td>
									<?php echo $registro[0][16] ?>
								</td>
							</tr>
							<tr class='bloquecentralcuerpo'>
								<td>
									<span>No de Periodos de Duraci&oacute;n:</span>
								</td>
								<td>
							...
							<tr class='bloquecentralcuerpo'>
								<td>
									<span>T&iacute;tulo que otorga:</span>
								</td>
								<td>
							...
							<tr class='bloquecentralcuerpo'>
								<td>
									<span class="texto_negrita" >Coordinador Actual:</span>
								</td>
								<td>
									<?php echo $registro[0][20] ?>
								</td>
							</tr>
						</table>
					</td>
