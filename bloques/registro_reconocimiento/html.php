...
if(isset($_GET['id_reconocimiento']))
{
	...
	{
		$cadena_sql="SELECT `nombre` , `puntos` , `anno`,`identificacion` ";
		$cadena_sql.="FROM `".$configuracion["prefijo"]."profesor_info_reconocimiento` ";
		$cadena_sql.="WHERE id_reconocimiento=".$_GET['id_reconocimiento']." LIMIT 1";
		//echo $cadena_sql;
  ...
  <table class="bloquelateral" cellpadding="5" cellspacing="1" width="100%">
    <tbody>
      <tr class="mensajealertaencabezado">
		...
		Informaci&oacute;n de reconocimientos recibidos
	</td>
      </td>
      </tr>	
      ...
      <tr class="bloquecentralcuerpo">
        ...
        <td class="celdatabla">
        	<input maxlength="80" size="30" name="puntos" value="<?PHP   echo $registro[0][1] ?>">
        </td>
      </tr>
      <tr align="center">
        <td colspan="2" rowspan="1" valign="undefined">
		<input type="hidden" name="action" value="registro_reconocimiento">
  ...
  <table class="bloquelateral" cellpadding="5" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr class="bloquecentralcuerpo">
        ...
        <td class="celdatabla">
        	<input maxlength="80" size="30" name="puntos">
        </td>
      </tr>
      <tr class="bloquecentralcuerpo">
        <td class="celdatabla">
