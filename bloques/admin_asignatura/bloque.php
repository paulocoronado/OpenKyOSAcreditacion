...
<a href="<?php echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('agregar_asignatura').'&asignatura='.$registro[$contador][0].'&usuario='.$_GET['usuario'].'&registro='.$_GET['registro']; ?>">Editar</a>
</td>
