  ...
  <tbody>
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('admin_recurso_informatico').'&accion=1'; ?>">Informaci&oacute;n de utilizaci&oacute;n de recursos inform&aacute;ticos</A>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=100%>
