...
<a href="<?php echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('editar_iioc_profesor').'&informacion=1&registro='.$registro[$contador][2]; ?>">Informaci&oacute;n</a>
</td>
</tr><?php }?>
</table><br>
</form>
