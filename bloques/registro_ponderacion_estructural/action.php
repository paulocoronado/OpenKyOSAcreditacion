...
function editar_registro($configuracion,$base,$id_usuario)
{
	...
	{
		if(substr($clave,0,strlen("incidencia_"))=="incidencia_")
		{
			
			$componentes=explode("_",$clave);
			$mi_componente_a=$componentes[1]."_".$componentes[2]."_".$componentes[3]."_".$componentes[4];
			$mi_componente_b=$componentes[5]."_".$componentes[6]."_".$componentes[7]."_".$componentes[8];
...
function nuevo_registro($configuracion,$base,$id_usuario)
{
	...
	while(list($clave,$valor)=each($_POST))
	{
		if(substr($clave,0,strlen("incidencia_"))=="incidencia_")
		{
			...
			$cadena_sql.="'".$id_usuario."', ";
			$cadena_sql.="'".$mi_componente_a."', ";
			$cadena_sql.="'".$mi_componente_b."', ";
			$cadena_sql.="'".$valor."', ";
			$cadena_sql.="'".$fecha."' ";
			$cadena_sql.=")";
			//echo $cadena_sql."<br>";
