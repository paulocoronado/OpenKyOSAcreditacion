...
if (is_resource($enlace))
{
	...
	if(isset($_GET['accion']))
	{
		...
		{	
			//Todos los servicio
			case '1':
				$cadena_sql="SELECT id_programa,anno";
...
<table style="text-align: left; width: 100%;" border="0"  cellpadding="5" cellspacing="0" class="bloquelateral">
  <tbody>
    <tr class="mensajealertaencabezado">
      <td >Actualmente no hay informaci&oacute;n sobre deserci&oacute;n registrada en el sistema</td>
    </tr>
    </tbody>
</table><?php  
	}
...
<a href="<?php  
$opciones=$configuracion["site"].'/index.php?page='.enlace('registro_plan_desercion');
...
$opciones=$configuracion["site"].'/index.php?page='.enlace('borrar_plan_desercion');
$opciones.='&opcion=plan_desercion';
$opciones.='&anno='.$registro[$contador][1]; 
$opciones.='&programa='.$registro[$contador][0]; 
