...
*****************************************************************************************************************/ 
?><?php  
if(!key_exists('id_artefacto',$_POST)||!key_exists('fecha_creacion',$_POST)||!key_exists('nombre',$_POST))
{
	...
	else
	{
		...
		*/
		...
		if (is_resource($enlace))
		{
			...
			$cadena_sql="DELETE FROM ".$configuracion["prefijo"]."a_borrador WHERE id_sesion='".$esta_sesion."'";
			//echo $cadena_sql."<br>";
			...
			$cadena_sql="INSERT INTO ".$configuracion["prefijo"]."a_borrador ";
			$cadena_sql.="(";
			...
			{	
				...
				$pagina="registro_artefacto_formulario";
