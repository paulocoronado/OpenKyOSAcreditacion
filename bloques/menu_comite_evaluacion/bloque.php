...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral">
  ...
  <tbody>	<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('admin_com_profesor').'&accion=1'; ?>">Informaci&oacute;n sobre producci&oacute;n docente.</A>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=100%>
