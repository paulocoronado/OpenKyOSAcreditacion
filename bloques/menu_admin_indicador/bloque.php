...
if($enlace)
{
	...
	//echo $variables_get;
	$nueva_sesion->guardar_valor_sesion($configuracion,"enlace_admin_informe",$variables_get,$esta_sesion);
}
		...
		<TD WIDTH=100% class="bloquelateralcuerpo">
			<table>
				<tr>
					...
					<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('admin_indicador').'&accion=1&hoja=0'; ?>"><img width="24" height="24" src="<?php   echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/componentes.png" alt="Administraci&oacute;n de Informes" title="Administraci&oacute;n de Informes" border="0" /> Indicadores</A>
					</td>
				</tr>
			</table>
		</TD>
