...
if (is_resource($enlace))
{
	...
	if(isset($_GET['accion']))
	{
		...
		{	
			//Todos los servicio
			case '1':
				$cadena_sql="SELECT id_proceso,id_programa,anno";
...
<table style="text-align: left; width: 100%;" border="0"  cellpadding="5" cellspacing="0" class="bloquelateral">
  <tbody>
    <tr class="mensajealertaencabezado">
      <td >Actualmente no hay informaci&oacute;n de admisiones registrados en el sistema</td>
    </tr>
    </tbody>
</table><?php  
	}
...
<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('registro_plan_admision').'&registro='.$registro[$contador][0]; ?>">Editar</a>
</td>
<td align="center" class="celdatabla"><?php  //TODO: Implementar la funcionalidad de Borrar?>
<a href="<?php  

$opciones=$configuracion["site"].'/index.php?page='.enlace('borrar_plan_admision');
$opciones.='&opcion=plan_admision';
