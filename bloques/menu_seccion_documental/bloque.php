...
if($enlace)
{
	...
	$pagina=$nueva_sesion->rescatar_valor_sesion($configuracion,"enlace_edu");
}
?><TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral2" >
	<TR>
		<TD WIDTH=100% class="bloquelateralcuerpo">
			...
			<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?'.$pagina[0][0]; ?>"><img width="24" height="24" src="<?php   echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/hogar.png" alt="Regresar" title="Regresar" border="0" /> Ir a subsistema</A>
			</td>
			</tr>
			</table>
		</TD>
