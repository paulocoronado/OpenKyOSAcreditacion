...
if (is_resource($enlace))
{
	...
	if(isset($_GET['accion']))
	{
		...
		{	
			//Todos los proyectos
			case '1':
				$cadena_sql="SELECT id_proyecto,nombre, anno,estado";
				$cadena_sql.=" FROM ".$configuracion["prefijo"]."dir_proyecto WHERE id_programa=".$id_programa." ORDER BY anno,nombre ";
				//echo $cadena_sql;
				break;
...
<table style="text-align: left; width: 100%;" border="0"  cellpadding="5" cellspacing="0" class="bloquelateral">
  <tbody>
    <tr class="mensajealertaencabezado">
      <td >Actualmente no hay proyectos del programa registrados en el sistema</td>
    </tr>
    </tbody>
</table>
...
<a href="<?php echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('editar_dir_proyecto').'&usuario='.$_GET['usuario'].'&registro='.$registro[$contador][0]; ?>">Editar</a>
</td>
<td align="center" class="celdatabla">
<a href="<?php echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('borrar_dir_proyecto').'&opcion=dir_proyecto&usuario='.$_GET['usuario'].'&registro='.$registro[$contador][0]; ?>">Borrar</a> 
</td>
</tr><?php }?>
</table><br>
</form>
