	...
	if(isset($_GET['accion']))
	{
		...
		{	
			...
			case '1':
				...
				$cadena_hoja="SELECT ";
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.id_artefacto,"; 
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.nombre,"; 
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.fecha_creacion, ";
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.descripcion,"; 
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.id_usuario,"; 
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.tipo,"; 
				$cadena_hoja.="".$configuracion["prefijo"]."registrado.nombre ";
				$cadena_hoja.="FROM "; 
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto, ";
				$cadena_hoja.="".$configuracion["prefijo"]."registrado ";
				$cadena_hoja.="WHERE ";
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.id_usuario=".$el_usuario;
				$cadena_hoja.=" AND ";
				$cadena_hoja.="".$configuracion["prefijo"]."artefacto.id_usuario = ".$configuracion["prefijo"]."registrado.id_usuario ";
				$cadena_hoja.=" ORDER BY nombre ";
				
				$cadena_sql="SELECT ";
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.id_artefacto,"; 
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.nombre,"; 
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.fecha_creacion, ";
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.descripcion,"; 
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.id_usuario,"; 
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.tipo,"; 
				...
				$cadena_sql.="WHERE ";
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.id_usuario=".$el_usuario;
				$cadena_sql.=" AND ";
				$cadena_sql.="".$configuracion["prefijo"]."artefacto.id_usuario = ".$configuracion["prefijo"]."registrado.id_usuario ";
			...
			case '2':
				...
				if(isset($_GET["autor"]))
				{
					...
					if($id_autor>0)
					{
						$condicion.="(".$configuracion["prefijo"]."artefacto.id_usuario=".$id_autor.") AND";					
					}
				...
				if(isset($_GET['busqueda']))
				{
					...
					{
						$buscar_nombre.="".$configuracion["prefijo"]."artefacto.nombre like '%".$val."%' OR ";
					}
...
?><form method="POST" action="index.php" name="registrar_artefacto_artefacto" onsubmit="return ()">
...
<td align="center" class="celdatabla">
	...
	<input type="hidden" name="ORDEN_<?PHP   echo $registro[$contador][0]; ?>"  value="1">
</td>
<?PHP  
			}
			else
...
<tr class="bloquecentralcuerpo">
	...
	$opcion=$configuracion["site"].'/index.php?page='.enlace('registro_proceso_artefacto');
	$opcion.=$variable; 
	echo $opcion;
...
<?PHP   echo $oculto; ?>
<input type='hidden' name='action' value='registro_proceso_artefacto'>
<br><hr>
...
<tr class="mensajealertaencabezado">
<td colspan="3">Artefactos asociados al proceso</td>
</tr>
<tr class="mensajealertaencabezado">
...
<?PHP   echo $la_artefacto[$contador][2]; ?>
</td>
	<td align="center" class="celdatabla">
	<input type="hidden" name="ACTUAL_ORDEN_<?PHP   echo $registro[$contador][0]; ?>"  value="1">
	<input checked="checked" name="ACTUAL_ELEMENTO_<?PHP   echo $la_artefacto[$contador][0]; ?>"  value="1" type="checkbox">
</td>
</tr>
<?PHP  	}
}
