...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral">
		...
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<BR><a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('agregar_uso_recurso').'&accion=1&usuario='.$_GET['usuario']; ?>">Agregar un nuevo registro</A>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=100%>
