...
if (is_resource($enlace))
{
	if(isset($_POST["aceptar"]))
	{
		...
		$cadena_sql="SELECT max(id_instrumento) FROM ".$configuracion["prefijo"]."instrumento";
		...
		$cadena_sql="INSERT INTO ".$configuracion["prefijo"]."instrumento ";
		$cadena_sql.="(";
		...
		$cadena_sql.="archivo_base,";
		$cadena_sql.="etiqueta ";
		$cadena_sql.="FROM ".$configuracion["prefijo"]."i_borrador ";
		$cadena_sql.="WHERE id_sesion='".$esta_sesion."'";	
		//echo $cadena_sql."<br>";	
		$resultado=$acceso_db->ejecutar_acceso_db($cadena_sql);
		
		$cadena_sql_1="INSERT INTO ".$configuracion["prefijo"]."i_pregunta";
		$cadena_sql_1.="(";
		...
		{	$cadena_sql="DELETE FROM ".$configuracion["prefijo"]."instrumento ";
			$cadena_sql.="WHERE id_instrumento=".$este_instrumento;
			$resultado=$acceso_db->ejecutar_acceso_db($cadena_sql);
			$cadena_sql="DELETE FROM ".$configuracion["prefijo"]."i_pregunta ";
			$cadena_sql.="WHERE id_instrumento=".$este_instrumento;
			$resultado=$acceso_db->ejecutar_acceso_db($cadena_sql);
