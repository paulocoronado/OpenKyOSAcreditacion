...
{
	$borrar_cadena_sql="SELECT nombre FROM ".$configuracion["prefijo"]."dir_proyecto WHERE id_proyecto=".$_GET["registro"]." LIMIT 1";
...
//Si
$opciones.="<td>\n";
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('proyecto_borrado');
$opciones.='&opcion=dir_proyecto';
$opciones.='&accion=1';
...
//No
$opciones.="<td>\n";
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('admin_dir_proyecto');
$opciones.='&usuario='.$_GET["usuario"];
$opciones.='">No</a><br>';
$opciones.="</td>\n"; 
$opciones.="</tr>\n";
