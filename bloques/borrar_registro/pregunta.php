...
if (is_resource($borrar_enlace))
{
	...
	$borrar_cadena_sql.="".$configuracion["prefijo"]."pregunta ";
	$borrar_cadena_sql.="WHERE ";
	$borrar_cadena_sql.="id_pregunta=".$_GET["registro"]." ";
...
$opciones.="<td>\n";
//Si
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('pregunta_borrado');
$opciones.=$variable.'">Si</a>';
$opciones.="</td>\n";
//No
$opciones.="<td>\n";
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('comite_pregunta');
$opciones.=$variable;
$opciones.='">No</a>';
$opciones.='<br>';
$opciones.="</td>\n"; 
