...
if (is_resource($borrar_enlace))
{
	...
	$borrar_cadena_sql.="".$configuracion["prefijo"]."evidencia_edu ";
	$borrar_cadena_sql.="WHERE ";
	$borrar_cadena_sql.="id_evidencia='".$_GET["evidencia"]."' ";
...
$opciones.="<td>\n";
//Si
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('evidencia_borrado');
$opciones.=$variable.'">Si</a>';
$opciones.="</td>\n";
//No
$opciones.="<td>\n";
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('admin_evidencias_edu');
$opciones.=$variable;
$opciones.='">No</a>';
$opciones.='<br>';
$opciones.="</td>\n"; 
