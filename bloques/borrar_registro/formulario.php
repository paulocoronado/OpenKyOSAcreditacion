...
if (is_resource($borrar_enlace))
{
	...
	$borrar_cadena_sql.="".$configuracion["prefijo"]."instrumento ";
	$borrar_cadena_sql.="WHERE ";
	$borrar_cadena_sql.="id_instrumento=".$_GET["registro"]." ";
...
$opciones.="<td>\n";
//Si
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('formulario_borrado');
$opciones.=$variable.'">Si</a>';
$opciones.="</td>\n";
//No
$opciones.="<td>\n";
$opciones.='<a href="'.$configuracion["site"].'/index.php?page='.enlace('comite_formulario');
$opciones.=$variable;
$opciones.='">No</a>';
$opciones.='<br>';
$opciones.="</td>\n"; 
