...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral">
		...
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<BR><a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('agregar_documento').'&accion=1'; ?>">Agregar documento</A>
			</TD>
		</TR>
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
		...
		<TR>
			<TD>
				...
				<TR>	
					<TD WIDTH=100% class="bloquelateralcuerpo">
						<INPUT type="hidden" NAME="page" VALUE="<?php   echo enlace('admin_documento') ?>">
