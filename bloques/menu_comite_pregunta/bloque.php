  ...
  <tbody>
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<a href="<?echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('comite_pregunta_primitiva').'&accion=1'; ?>">Tipo primitiva</A>
			</TD>
		</TR>
		<TR>
			<td class="bloquelateralcuerpo">
				<a href="<?echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('comite_pregunta_compuesta').'&accion=1'; ?>">Tipo compuesta</A>
			</TD>
		</TR>
		<TR>
			<td class="bloquelateralcuerpo">
...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral">
   <tbody>		
		...
		<TR>
			<TD WIDTH=100% class="bloquelateralencabezado">
				<INPUT type="hidden" NAME="page" VALUE="<?php echo enlace('comite_pregunta') ?>">
