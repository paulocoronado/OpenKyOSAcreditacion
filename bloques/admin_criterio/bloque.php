...
<td bgcolor="<?php  echo $tema->celda ?>"><?php  echo $registro[$contador][1] ?>
...
<input type="hidden" name= "criterio_<?PHP  echo $contador ?>" value="<?php echo $registro[$contador][0] ?>">
</td>
<?php  /*<td class="celdatabla"><?php  echo $registro[$contador][2] ?></td>*/?>
<td align="center" bgcolor="<?php  echo $tema->celda ?>"><?php  echo $registro[$contador][2] ?></td>
