	...
	if(isset($_GET['accion']))
	{
		...
		{	
			...
			case '1':
				...
				$cadena_sql.=" ORDER BY id_proceso ";
...
<?php
			if($el_usuario==$registro[$contador][4])
			{
				...
				$cadena_sql.="* ";
				$cadena_sql.="FROM ";
				$cadena_sql.=$configuracion["prefijo"]."aplicacion ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="id_proceso=".$registro[$contador][0]." ";
				$cadena_sql.="LIMIT 1";
...
<a href="<?php
	$opcion=$configuracion["site"].'/index.php?page='.enlace('borrar_proceso');
	$opcion.=$variable; 
	$opcion.="&opcion=proceso";
...
<table width="100%" cellpadding="2" cellspacing="2" class="bloquelateral">
  <tr class="bloquecentralcuerpo">
    <td align="left" class="celdatabla" width="33%"><?php
		if($_GET["hoja"]>0)
		{
	?>
	...
	$opcion=$configuracion["site"].'/index.php?page='.enlace('comite_proceso');
	$opcion.=$variable;
...
?>"><< Anterior</a>
    ...
    <td align="right" class="celdatabla" width="33%"><?php
		if($_GET["hoja"]<$hoja)
		{
	?>
