...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql.="WHERE ";
		$cadena_sql.=$configuracion["prefijo"]."dir_proyecto.id_programa=".$this->id_programa." ";
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."dir_proyecto.funcion LIKE '1%1' ";
		$cadena_sql.="OR ";
		$cadena_sql.=$configuracion["prefijo"]."dir_proyecto.funcion LIKE '11%' ";
		$cadena_sql.="ORDER BY ";
		...
		<td><?php  //Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Proyectos de car&aacute;cter investigativo articulados a actividades de docencia y de proyecci&oacute;n social.</b><hr>		
						</td>
					</tr>	
					<tr>
