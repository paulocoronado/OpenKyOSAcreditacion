...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."dir_proyecto.curriculo=1 ";
		$cadena_sql.="ORDER BY ";
		...
		<td><?php  //Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Proyectos que propenden por la modernizaci&oacute;n, actualizaci&oacute;n y pertinencia del currículo.</b><hr>						
						</td>
					</tr>	
					<tr>
