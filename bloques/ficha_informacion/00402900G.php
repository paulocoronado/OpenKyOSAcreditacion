...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql.=$configuracion["prefijo"]."bibliografia_programa.cantidad, ";
		...
		$cadena_sql.="WHERE ";
		$cadena_sql.=$configuracion["prefijo"]."bibliografia_programa.id_programa=".$this->id_programa." ";
		$cadena_sql.="AND ";
		...
		<td><?php//Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>N&uacute;mero y utilizaci&oacute;n de recursos disponibles en la Biblioteca</b><hr>						
						</td>
					</tr>	
					<tr>
			...
			<table class='tablarespuesta' align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr class="bloquecentralcuerpo" >
						...
						<td class="celdapresentacion" align='center'>
						<b>No Profesores<br>que lo usan</b>
						</td>
						<td class="celdapresentacion" align='center'>
						<b>No de Estudiantes<br>que lo usan</b>
						</td>
					</tr><?php
