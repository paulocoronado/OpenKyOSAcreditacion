...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql.="WHERE ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_dedicacion.id_programa=".$this->id_programa." ";
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_dedicacion.identificacion=".$configuracion["prefijo"]."profesor.identificacion"." ";
		$cadena_sql.="ORDER BY ";
		$cadena_sql.=$configuracion["prefijo"]."profesor.apellido,".$configuracion["prefijo"]."profesor.nombre ASC ";
		...
		<td><?php  //Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Dedicaci&oacute;n de los docentes de acuerdo a las funciones esenciales de la Universidad</b><hr>						
						</td>
					</tr>	
					<tr>
			...
			$cadena_administrativa="<table class='tablarespuesta' align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>\n";
			$cadena_administrativa.="<tbody>\n";
			$cadena_administrativa.="<tr class='bloquecentralcuerpo' >\n";
			$cadena_administrativa.="<td class='celdapresentacion' align='center' colspan='5'>\n";
			$cadena_administrativa.="<b>Enmarcado dentro de las funciones Administrativas</b>\n";
			$cadena_administrativa.="</td>\n";
			$cadena_administrativa.="</tr>\n";
			$cadena_administrativa.=$cadena_encabezado;
			...
			for($i=0;$i<$conteo_recursos;$i++)
			{
				...
				$cadena_administrativa.=$cadena_registro;
				
				$cadena_investigacion.=$registro_recursos[$i][5];
				$cadena_docencia.=$registro_recursos[$i][4];
				$cadena_extension.=$registro_recursos[$i][6];
				$cadena_administrativa.=$registro_recursos[$i][7];
