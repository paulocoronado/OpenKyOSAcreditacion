...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql.="FROM ";
		$cadena_sql.=$configuracion["prefijo"]."dir_convenio ";
		$cadena_sql.="WHERE ";
		$cadena_sql.="id_programa=".$this->id_programa." ";
		$cadena_sql.="AND ";
		$cadena_sql.="calidad=1 ";
		$cadena_sql.="ORDER BY ";
		$cadena_sql.="anno, ";
		$cadena_sql.="nombre ";
		$cadena_sql.="ASC ";
		...
		<td><?php  //Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Convenios y actividades de cooperaci&oacute;n acad&eacute;mica suscritos y desarrolladas por el programa con instituciones y programas de alta calidad, acreditados por entidades de reconocida legitimidad nacional e internacional.</b><hr>						
						</td>
					</tr>	
					<tr>
