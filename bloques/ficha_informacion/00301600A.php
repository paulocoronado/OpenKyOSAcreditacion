...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql="SELECT ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.id_material, ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.identificacion, ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.nombre, ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.descripcion, ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.anno, ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.tipo, ";
		...
		$cadena_sql.="ORDER BY ";
		$cadena_sql.=$configuracion["prefijo"]."com_material.anno,".$configuracion["prefijo"]."profesor.apellido ASC ";
	...
	<tr class="bloquecentralcuerpo">
		<td><?php  //Mostrar los resultados?>
			...
			?>		<tr class="bloquecentralcuerpo" >
						...
						<b><?php   echo $registro_recursos[$i][6]." ".$registro_recursos[$i][7];?></b>
						</td>
						<td class="celdapresentacion" align='center'>
