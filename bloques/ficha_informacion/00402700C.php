...
if (is_resource($enlace))
{
	...
	if(isset($this->ficha_informacion) && isset($this->id_programa))
	{
		...
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_dedicacion.identificacion=".$configuracion["prefijo"]."profesor_info_anual.identificacion"." ";	
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_dedicacion.anno=".$configuracion["prefijo"]."profesor_info_anual.anno"." ";		
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_anual.id_titulo=".$configuracion["prefijo"]."valores_profesor.id_valor"." ";
		$cadena_sql.="ORDER BY ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_dedicacion.anno,";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_dedicacion.periodo,";
		$cadena_sql.=$configuracion["prefijo"]."profesor.apellido,";
		...
		<td><?php  //Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Nivel de formaci&oacute;n de los profesores investigadores del programa.</b><hr>
						</td>
					</tr>	
					<tr>
			...
			$cadena_encabezado.="</td>\n";
			$cadena_encabezado.="<td class='celdapresentacion' align='center'>\n";
			$cadena_encabezado.="<b>Nivel de<br>Formaci&oacute;n</b>\n";
			$cadena_encabezado.="</td>\n";
			...
			for($i=0;$i<$conteo_recursos;$i++)
			{
				...
				$cadena_registro.=$registro_recursos[$i][5]." ".$registro_recursos[$i][6];
				$cadena_registro.="</td>\n";
				$cadena_registro.="<td class='celdapresentacion' align='center'>\n";
				$cadena_investigacion.=$cadena_registro;
				$cadena_investigacion.=$registro_recursos[$i][4];
				$cadena_registro="</td>\n";
				$cadena_registro.="<td class='celdapresentacion'>\n";
				$cadena_registro.=$registro_recursos[$i][8];
				$cadena_registro.="</td>\n";
				$cadena_registro.="</tr>\n";
				$cadena_investigacion.=$cadena_registro;
