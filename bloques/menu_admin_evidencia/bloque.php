...
<TR class="bloquelateralcuerpo">
	<TD>
		<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('registro_evidencia_edu').'&accion=1&hoja=0&criterio='.$_GET["criterio"]; ?>">Agregar Evidencia</A>
	</TD>
</TR>
