...
/*Como es una previsualización se muestran los datos básicos del formulario*/	
	...
	$cadena_html.="<input type='hidden' name='action' value='guardar_artefacto'>\n";
	...
	$cadena_html.="&iquest;Desea guardar el artefacto en el Sistema?";
	$cadena_html.="</td>\n";
	$cadena_html.="</tr>\n";
	...
	$cadena_sql="SELECT id_artefacto, fecha_creacion, id_usuario, nombre, responsable,";
	$cadena_sql.="presentacion, descripcion FROM ".$configuracion["prefijo"]."a_borrador WHERE id_artefacto=1 AND ";
...
<td colspan="3">Artefacto compuesto por:</td>
</tr>
<tr class="mensajealertaencabezado">
