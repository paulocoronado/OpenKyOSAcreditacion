...
if (is_resource($enlace))
{
	...
	if(isset($ficha_informacion) && isset($id_programa))
	{
		...
		$cadena_sql.="WHERE ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_anual.id_programa=".$id_programa." ";
		$cadena_sql.="AND ";
		$cadena_sql.=$configuracion["prefijo"]."profesor_info_anual.id_tipo_vinculacion=1 ";
		$cadena_sql.="AND ";
		...
		<td><?php//Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Profesores de Planta del Programa.</b><hr>
						</td>
					</tr>	
					<tr>
			...
			$cadena_encabezado.="</td>\n";
			$cadena_encabezado.="<td class='celdapresentacion' align='center'>\n";
			$cadena_encabezado.="<b>T&iacute;tulo</b>\n";
			$cadena_encabezado.="</td>\n";
			...
			for($i=0;$i<$conteo_recursos;$i++)
			{
				...
				$cadena_registro.=$registro_recursos[$i][6]." ".$registro_recursos[$i][7];
				$cadena_registro.="</td>\n";
				$cadena_registro.="<td class='celdapresentacion' align='center'>\n";
				$cadena_registro.=$registro_recursos[$i][5];
				$cadena_registro.="</td>\n";
				$cadena_registro.="</tr>\n";
