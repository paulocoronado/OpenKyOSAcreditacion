...
if (is_resource($enlace))
{
	...
	if(isset($ficha_informacion) && isset($id_programa))
	{
		...
		$cadena_sql.="`premio` ";
		$cadena_sql.="FROM ";
		$cadena_sql.=$configuracion["prefijo"]."estudiante_info_trabajo "; 
		$cadena_sql.="WHERE ";
		$cadena_sql.="id_programa=".$id_programa." ";
		$cadena_sql.="AND ";
		$cadena_sql.="premio !='' ";
		...
		<td><?php//Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Trabajos realizados por estudiantes del programa que han merecido premios o reconocimientos significativos de parte de la comunidad acad&eacute;mica nacional o internacional.</b><hr>						
						</td>
					</tr>	
					<tr>
			...
			?>		<tr class="bloquecentralcuerpo" >
						...
						<td class="celdapresentacion">
						<?php echo $registro_recursos[$i][5]." ".$registro_recursos[$i][6];?>
						</td>
						<td class="celdapresentacion" >
