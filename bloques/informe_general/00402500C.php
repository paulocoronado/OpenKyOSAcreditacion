		...
		<td><?php//Mostrar los resultados?>
			<table align='center' style='width: 100%; text-align: left;' cellpadding='5' cellspacing='1'>
				<tbody>
					<tr>
						<td align='center'>
						<b>Actividades desarrolladas por el programa para que profesores, estudiantes y egresados participen en la definici&oacute;n de pol&iacute;ticas en materia de docencia, investigaci&oacute;n, proyecci&oacute;n social y cooperaci&oacute;n internacional, y en las decisiones ligadas al programa.</b><hr>						
						</td>
					</tr>	
					<tr>
			...
			?>		<tr class="bloquecentralcuerpo" >
						...
						<td class="celdapresentacion" >
						<?php echo $registro_recursos[$i][4];?>
						</td>
						<td class="celdapresentacion">
						<?php 
						if($registro_recursos[$i][5]==0)
						{
							echo "Nacional";
						}
						else
