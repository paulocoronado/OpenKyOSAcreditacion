  ...
  <tbody>
		<TR>
			<TD WIDTH=100% class="bloquelateralcuerpo">
				<a href="<?php  echo $configuracion["host"].$configuracion["site"].'/index.php?page='.enlace('registro_artefacto').'&accion=1&hoja=0'; ?>">Crear artefacto</A>
			</TD>
		</TR>
		<TR>
...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=5 CELLSPACING=0 class="bloquelateral">
   <tbody>		
		...
		<TR>
			<TD WIDTH=100% class="bloquelateralencabezado">
				<INPUT type="hidden" NAME="page" VALUE="<?php   echo enlace('comite_artefacto') ?>">
